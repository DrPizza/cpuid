	...
	{ leaf_t::extended_signature_and_features, {
		{ subleaf_t::main, {
			{ ecx, {
				...
				{         amd            , 0x0200'0000_u32, "DataBreakpointExtension" , "Data Breakpoint support"              },
				{         amd            , 0x0400'0000_u32, "PerfTsc"                 , "Performance Time Stamp Counter"       },
			...
			{ edx, {
				...
				{ intel | amd            , 0x0000'0800_u32, "SysCallSysRet" , "SYSENTER and SYSEXIT Instructions"    },
